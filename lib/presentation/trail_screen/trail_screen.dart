    ...
    return BlocProvider(
      ...
      child: BlocBuilder<TrailBloc, TrailState>(
        builder: (context, state) {
          ...
          // Membuat TrailScreenModel menggunakan ResDetailRouteCentres
          final trailModel =
            ...
            child: Scaffold(
              ...
              body: Stack(
                children: [
                  ...
                  _buildHeaderSection(context, trailModel, state.jalur),

                  // Content Section (with trail details, actions, and buttons at the bottom)
                  Align(
        ...
        children: [
          ...
          if (jalur != null &&
            ...
            Positioned(
              ...
              right: 16.h,
              child: WeatherBadge(
                latitude: jalur.latitude,
                longitude: jalur.longitude,
                locationName: jalur.nama,
              ),
            ),
        ],
      ),
            ...
            child: TextButton(
              ...
              child: Row(
                ...
                children: [
                  ...
                  SizedBox(width: 8),
                  Text(
                      "Jarak\n${trailModel.distanceLabel} km", // Teks dengan dua baris
