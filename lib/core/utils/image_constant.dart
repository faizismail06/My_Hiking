...
class ImageConstant {
  ...
  // Kode Verifikasi images
  static String imgGroup297 = '$imagePath/img_group_297.png';

  // Pop up lengkapi data diri images
  ...
  // Pilihan bank pembayaran images
  static String imgLogo = '$imagePath/img_logo.png';
  static String imgLogoBankBri1 = '$imagePath/img_logo_bank_bri_1.png';
  static String imgPngwingCom1 = '$imagePath/img_pngwing_com_1.png';
  ...
  static String imgMountainPicture = '$imagePath/img_mountain_picture.png';
  ...
  static String imgIconArrowTeal900 = '$imagePath/img_icon_arrow_teal_900.svg';
  static String imgETickets = '$imagePath/img_e_tickets.svg';

  // RIWAYAT images
  static String imgIconMapPrimary = '$imagePath/img_icon_map_primary.svg';
